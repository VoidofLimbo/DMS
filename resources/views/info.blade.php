...
<body class="font-sans antialiased h-screen">
    ...
    <div class="relative bg-white overflow-hidden h-screen">
        <div class="max-w-7xl mx-auto h-screen">
            <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32 md:h-screen">
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        ...
                        <p
                            ...
                            {{ __('Demo is only available on request, for pre-determined time preiod. Please access the demo within agreed time period.') }}</p>
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="h-screen w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
