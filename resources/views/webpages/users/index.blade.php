                            ...
                            <table class="min-w-full divide-y divide-gray-200 w-full">
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td class="flex flex-wrap justify-start px-6 py-4 text-sm text-gray-900">
                                            @foreach ($user->roles as $role)
                                                <span class="px-2 m-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                                    {{ $role->title }}
                                                </span>
                                            @endforeach
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <form class="inline-block" action="{{ route('users.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                ...
                                                <input type="submit" class="text-red-600 cursor-pointer hover:text-red-900 mb-2 mr-2" value="Delete">
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
