<section class="mb-20 text-gray-700">
    <div class="text-center md:max-w-xl lg:max-w-3xl mx-auto">
        <h3 class="text-3xl font-bold mt-6 mb-6 text-gray-800">Testimonials</h3>
        <p class="mb-6 pb-2 md:mb-12 md:pb-0">
            Here will be some testimonials from different care homes.
    ...
    <div class="grid md:grid-cols-3 gap-6 lg:gap-12 text-center">
        <div class="mb-12 md:mb-0">
            ...
            <h5 class="text-xl font-semibold mb-4">Carehome owner</h5>
            <h6 class="font-semibold text-blue-600 mb-4">Carehome Name</h6>
            <p class="mb-4">
